...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_simple_progress__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_simple_progress___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_simple_progress__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ProgressBar: __WEBPACK_IMPORTED_MODULE_0_vue_simple_progress___default.a
    },
    data: function data() {
        return {
            clientsList: [],
    ...
    methods: {
        color: function color(noOfContracts, usedContracts) {
        ...
        bartext: function bartext(noOfContracts, usedContracts) {

            return usedContracts.toString() + '/' + noOfContracts;
        },
        percentageCalculator: function percentageCalculator(noOfContracts, usedContracts) {
            ...
            //alert(((usedContracts/noOfContracts)*100).toFixed(3));

        }
    },
    created: function created() {
        var self = this;
        Nova.request().get('/getclientsinfo').then(function (response) {
  ...
  return _c("div", [
    _c(
      ...
      [
        _c("heading", { staticClass: "mb-3" }, [
          _vm._v("Module Usage Per Customer")
        ])
      ],
      1
    ),
    ...
    _c("div", [
      _c(
        ...
        _vm._l(_vm.clientsList, function(item) {
          return _c("div", { staticClass: "px-3 mb-6 mt-4 w-1/3" }, [
            _c(
              "div",
              { staticClass: "card relative metric px-6 py-4 relative" },
              [
                _c("div", { staticClass: "flex mb-4" }, [
                  _c(
                    "h3",
                    { staticClass: "mr-3 text-base text-80 font-bold" },
                ...
                _c(
                  ...
                  [
                    _c("p", {
                      staticClass: "module_name",
                      domProps: { textContent: _vm._s(item.module.name) }
                    }),
                    _vm._v(" "),
                    _c("progress-bar", {
                      attrs: {
                        "bg-color": _vm.color(
                          item.module.available_number,
                          item.module.module_usage
                        ),
                        size: "medium",
                        val: _vm.percentageCalculator(
                          item.module.available_number,
                          item.module.module_usage
                        ),
                        text: _vm.bartext(
