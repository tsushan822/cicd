...
export default {
    ...
    template: '<div><div id="wrapper" style="position: relative; height: 30vh"><canvas id="stackedlinegraph"></canvas></div><div><vue-slider v-bind="slider.default" v-model="internalrange" :min="20" :max="90" :step="4" :show="true" :data="rangemonths"  :lazy="true" :piecewise="true" :disabled="false" ></vue-slider></div></div>',
        ...
        load() {
            this.fetchData().then(response => {
                ...
                if (counterpartycount < 4) {
                    ...
                    var datasetColor = ["#81c7ef", "#5fafe4", "#4297d1", "#2980b7", "#176a9b", "#0e547c"];
          ...
          //                    "0, 186, 12", "104, 243, 113", "236, 6, 0", "255, 113, 109"
                ...
                if (typeof this.myChart !== "undefined") {
                    ...
                    var context = document.getElementById('stackedlinegraph').getContext('2d');
