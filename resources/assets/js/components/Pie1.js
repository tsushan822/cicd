...
export default{
    ...
    template: '<div id="wrapper2" style="position: relative; height: 22vh"><canvas id="pie1"></canvas><div id="chart-legends1"></div></div>',
    ...
    methods: {
        ...
        load() {
            ...
            if (typeof this.myChart !== "undefined") {
                ...
                document.getElementById("wrapper2").style.height = '22vh';
            ...
            document.getElementById("chart-legends1").innerHTML =  this.myChart.generateLegend();
