...
export default {
    template: '<canvas width="600" height="200" id="bar_with_decimals"></canvas>',
    ...
    mounted() {
        ...
        var context = document.getElementById('bar_with_decimals').getContext('2d');
                    ...
                    scales: {
                        ...
                        callbacks: {
                            label: function (tooltipItem, data) {
                                ...
                                var number=Number(tooltipItem.yLabel).toFixed(5);
