...
@section('content')
    ...
    {!!Form::open(['method' => 'delete','route'=>['portfolios.destroy',$portfolio->id],'id'=>'mmdeal-delete-form','class'=>'form-horizontal form-label-left']) !!}
    ...
    <section class=" mb-4 pb-3 alert black-text primary-background ">
        ...
        <div class="jumbotron mt-4 mb-0">
            ...
            <hr class="my-2">
            <p>@lang('master.Delete') ({!! $portfolio->name !!})
            </p>
