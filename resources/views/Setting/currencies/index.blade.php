    ...
    <div class="card ">
        <div class="card-header crud_table_header mb-2 d-flex justify-content-between ">
            <div  class="d-flex align-items-center">
                <h6 class="  pl-1">
                    <strong> @lang('master.Currencies')</strong>
                </h6>
            </div>
            <div id="datatable-buttons ">
                    <a class="btn btn-sm d-none  btn-primary-variant-main  px-2" href="{!! route('currencies.create') !!}">
        ...
        <div class="px-4" >
            ...
            <div class="table-wrapper" id="costcenter_table_area">
              ...
              collapsed', 'id' => 'datatable-currency']) !!}
            </div>
