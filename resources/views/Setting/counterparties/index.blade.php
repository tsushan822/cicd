    ...
    <div class="card ">
        <div class="card-header crud_table_header mb-2 d-flex justify-content-between ">
            <div  class="d-flex align-items-center">
                <h6 class="  pl-1">
                    <strong> @lang('master.Companies')</strong>
                </h6>
            </div>
            <div id="datatable-buttons">
                @if($view['import'])
                    <a class="btn btn-sm  btn-primary-variant-one  px-2" href="{!! url('/import/Setting/company') !!}">
                        <i class="fas fa-cloud-upload-alt"></i> @lang('master.Import')
                    </a>
                @endif

                @if($view['add_new'])
                        <a class="btn btn-sm  btn-primary-variant-main  px-2" href="{!! route('counterparties.create') !!}">
        ...
        <div class="px-4">
          ...
          collapsed', 'id' => 'datatable-counterparties']) !!}
            </div>
