        ...
        <div class="card ">
            <div class="card-header crud_table_header mb-2 d-flex justify-content-between ">
                <div  class="d-flex align-items-center">
                    <h6 class="  pl-1">
                        <strong>  @lang('master.Cost centers')</strong>
                    </h6>
                </div>
                <div id="datatable-buttons">
                    @can('import_costcenter')
                        <a class="btn btn-sm  btn-primary-variant-main  px-2" href="{!! url('/import/Setting/costcenter') !!}">
                            <i class="fas fa-cloud-upload-alt"></i> @lang('master.Import')
                        </a>
                    @endcan
                        @can('create_costcenter')
                            <a class="btn btn-sm  btn-primary-variant-main  px-2" href="{!! route('costcenters.create') !!}">
            ...
            <div class="px-4" >
              ...
              collapsed', 'id' => 'datatable-costcenters']) !!}
                </div>
