                ...
                <div class="container  d-flex justify-content-center align-items-center">
                    <div class="row flex-center ">
                        <div class="col-md-12 mb-5">
                            <a href="//{{ env('SERVER_URL') }}"><img src="../img/logo-blue.svg" alt="" class="srcimg"
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-12 right_custom_registartion">
                                        <div>
                                            <h3>Welcome to LeaseAccounting.app!</h3>
                                            <div class="sub">In order to login, please type your Email address</div>
                                        </div>

                                        <div class="spark-screen container">
                                            <div>
                                                <div class="companY_information mt-4 pt-1">
                                                    <form role="form" method="POST" action="{{ url('/login/initial') }}">
                                                        {!! csrf_field() !!}

                                                        <div class="form-row">
                                                                <div class="col-md-12">
                                                                    <label for="email" class="small  mb-1 active d-none">Email address</label>
                                                                    <input type="email" id="email" name="email" placeholder="Enter your email" class="form-control py-4" required autofocus>
                                                                    @if ($errors->has('email'))
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mt-4 d-flex align-items-center justify-content-start">
                                                                <div class="text-center">
                                                                    Dont' have an account?
                                                                    <u class="text-primary"> <a class="" href="{{route('register')}}">Sign up</a></u>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 mt-4 pr-2 d-flex justify-content-end">
