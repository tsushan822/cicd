...
@push('meta')
    ...
    <title>Change your password on LeaseAccounting.app</title>
@endpush
                            ...
                            <div class="row">
                                <div class="col-md-12 right_custom_registartion">
                                    <div>
                                        ...
                                        <div class="sub">Please set a strong password</div>
                                    </div>
                                            ...
                                            <div class="companY_information mt-4 pt-1">
                                                <form method="POST" action="{{ route('password.request') }}">
                                                    ...
                                                    <div class="form-row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label for="repeatpassword" class="small  mb-1 active d-none">Repeat password</label>
                                                                <input class="form-control py-4"   type="password" id="repeatpassword"  name="password_confirmation" placeholder="Repeat Password" required>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mt-4 pr-2 d-flex justify-content-end">
                                                            <button class="btn btn-light   btn-primary-variant-main  px-5 waves-effect waves-light" type="submit">
                                                                    <span>
                                                                        <i class="fa fa-btn fa-arrow-right"></i> Reset
                                                                    </span>
                                                            </button>
                                                        </div>
                                                    </div>
