...
@push('meta')
    ...
    <title>Change your password for LeaseAccounting.app</title>
@endpush
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 right_custom_registartion">
                                    <a href="/login"  class="nav_back" style=""><i class="fa fa-arrow-left"></i> Login</a>
                                    <div>
                                        <h3>Change your password</h3>
                                        <div class="sub">In order to change your password, please type your Email address</div>
                                    </div>
                                        ...
                                        <div>
                                            <div class="companY_information mt-4 pt-1">
                                                <form method="POST" action="{{ route('password.email') }}">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-12 ">
                                                            <div class="col-md-8 offset-md-2">
                                                                ...
                                                                <input type="email" id="email" name="email"  placeholder="Email address" value="{{ old('email') }}"  class="form-control py-4" required autofocus>
                                                                @if ($errors->has('email'))
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8 mt-4 pr-2 d-flex justify-content-end">
                                                            <p></p>
