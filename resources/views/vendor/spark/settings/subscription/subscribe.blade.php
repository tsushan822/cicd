<spark-subscribe-stripe :user="user" :team="team"
                        :plans="plans" :billable-type="billableType" inline-template ref="subscribeComponentRef">
    ...
    <!-- Billing Information -->
        <div class="" v-show="selectedPlan">
            <div class="card-header ml-2 px-4"><h5>{{__('Billing Information')}}</h5></div>
