...
Route::domain('{subdomain}.'.config('zenlease.server_url'))->group(function () {
    Route::get('/register', function(){
        return redirect()->route('login');
    });
});

Route::post('/tax-rate', 'TaxRateController@calculate');


Route :: group(['middleware' => Laravel\Spark\Spark ::mustVerifyEmail() ? ['web', 'verified'] : ['web']], function ($router) {
    // Users...
    ...
    $router -> group(['middleware' => 'web'], function ($router) {
        ...
        // Authentication...
        //$router -> get('/login', 'Auth\SparkLoginController@showLoginForm') -> name('login');
        //$router -> post('/login', 'Auth\SparkLoginController@login');
        //$router -> get('/logout', 'Auth\SparkLoginController@logout') -> name('logout');

        // Two-Factor Authentication Routes...
        //$router -> get('/login/token', 'Auth\SparkLoginController@showTokenForm');
        //$router -> post('/login/token', 'Auth\SparkLoginController@verifyToken');
